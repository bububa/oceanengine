...
func OperationLogGet(clt *core.SDKClient, accessToken string, req *enterprise.OperationLogGetRequest) (*enterprise.OperationLogGetResult, error) {
	var resp enterprise.OperationLogGetResponse
	if err := clt.Get("v1.0/enterprise/operation/log/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
