...
// 单次创建分包数量上限是100。
func ExtendPackageCreate(clt *core.SDKClient, accessToken string, req *appmanagement.ExtendPackageCreateRequest) error {
	return clt.Post("2/tools/app_management/extend_package/create/", req, nil, accessToken)
}
