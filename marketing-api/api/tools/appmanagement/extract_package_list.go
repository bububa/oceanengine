...
func ExtendPackageList(clt *core.SDKClient, accessToken string, req *appmanagement.ExtendPackageListRequest) (*appmanagement.ExtendPackageListData, error) {
	var resp appmanagement.ExtendPackageListResponse
	if err := clt.Get("2/tools/app_management/extend_package/list/", req, &resp, accessToken); err != nil {
		return nil, err
	}
