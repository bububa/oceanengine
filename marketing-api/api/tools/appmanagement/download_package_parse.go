...
func DownloadPackageParse(clt *core.SDKClient, accessToken string, req *appmanagement.DownloadPackageParseRequest) (string, error) {
	var resp appmanagement.DownloadPackageParseResponse
	if err := clt.Post("2/tools/app_management/download/package/parse/", req, &resp, accessToken); err != nil {
		return "", err
	}
