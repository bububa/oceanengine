...
func DownloadPackageGet(clt *core.SDKClient, accessToken string, req *appmanagement.DownloadPackageGetRequest) (appmanagement.DownloadPackageStatus, error) {
	var resp appmanagement.DownloadPackageGetResponse
	if err := clt.Get("2/tools/app_management/download/package/get/", req, &resp, accessToken); err != nil {
		return "", err
	}
