...
func Mid2ItemID(clt *core.SDKClient, accessToken string, req *comment.Mid2ItemIDRequest) (*comment.Mid2ItemIDList, error) {
	var resp comment.Mid2ItemIDResponse
	if err := clt.GetAPI("v3.0/tools/comment/mid2item_id/", req, &resp, accessToken); err != nil {
		return nil, err
	}
