...
func TermsBannedDelete(clt *core.SDKClient, accessToken string, req *comment.TermsBannedDeleteRequest) error {
	return clt.PostAPI("v3.0/tools/comment/terms_banned/delete/", req, nil, accessToken)
}
