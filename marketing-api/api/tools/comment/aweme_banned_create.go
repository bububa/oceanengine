...
func AwemeBannedCreate(clt *core.SDKClient, accessToken string, req *comment.AwemeBannedCreateRequest) (*comment.AwemeBannedCreateResponseData, error) {
	var resp comment.AwemeBannedCreateResponse
	if err := clt.Post("v3.0/tools/comment/aweme_banned/create/", req, &resp, accessToken); err != nil {
		return nil, err
	}
