...
func TermsBanndedUpdate(clt *core.SDKClient, accessToken string, req *comment.TermsBanndedUpdateRequest) error {
	return clt.Post("2/tools/comment/terms_bannded/update/", req, nil, accessToken)
}
