...
func TermsBannedUpdate(clt *core.SDKClient, accessToken string, req *comment.TermsBannedUpdateRequest) error {
	return clt.PostAPI("v3.0/tools/comment/terms_banned/update/", req, nil, accessToken)
}
