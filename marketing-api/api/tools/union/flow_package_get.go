...
func FlowPackageGet(clt *core.SDKClient, accessToken string, req *union.FlowPackageGetRequest) (*union.FlowPackageGetData, error) {
	var resp union.FlowPackageGetResponse
	if err := clt.Get("2/tools/union/flow_package/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
