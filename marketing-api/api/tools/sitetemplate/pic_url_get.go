...
func PicURLGet(clt *core.SDKClient, accessToken string, req *sitetemplate.PicURLGetRequest) (map[string]string, error) {
	var resp sitetemplate.PicURLGetResponse
	if err := clt.Get("2/tools/site_template/pic_url/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
