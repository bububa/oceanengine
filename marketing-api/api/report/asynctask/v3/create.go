...
func Create(clt *core.SDKClient, accessToken string, req *v3.CreateRequest) (*asynctask.Task, error) {
	var resp asynctask.CreateResponse
	if err := clt.PostAPI("v3.0/report/custom/async_task/create/", req, &resp, accessToken); err != nil {
		return nil, err
	}
