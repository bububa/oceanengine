...
func BrandGet(clt *core.SDKClient, accessToken string, advertiserID uint64) ([]dmp.BrandInfo, error) {
	req := dmp.BrandGetRequest{
		AdvertiserID: advertiserID,
	}
	var resp dmp.BrandGetResponse
	if err := clt.Get("2/dmp/brand/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
