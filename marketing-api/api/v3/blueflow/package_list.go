...
func PackageList(clt *core.SDKClient, accessToken string, req *blueflow.PackageListRequest) ([]blueflow.Package, error) {
	var resp blueflow.PackageListResponse
	if err := clt.GetAPI("v3.0/blue_flow_package/list/", req, &resp, accessToken); err != nil {
		return nil, err
	}
