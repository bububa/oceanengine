...
func VideoMaterialClearTaskCreate(clt *core.SDKClient, accessToken string, req *file.VideoMaterialClearTaskCreateRequest) (uint64, error) {
	var resp file.VideoMaterialClearTaskCreateResponse
	if err := clt.Post("2/file/video/material/clear_task/create/", req, &resp, accessToken); err != nil {
		return 0, err
	}
