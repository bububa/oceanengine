...
func MaterialDetail(clt *core.SDKClient, accessToken string, req *file.MaterialDetailRequest) ([]file.Material, error) {
	var resp file.MaterialDetailResponse
	if err := clt.Get("2/file/material/detail/", req, &resp, accessToken); err != nil {
		return nil, err
	}
