...
func AudienceFilePartUpload(clt *core.SDKClient, accessToken string, req *dmp.AudienceFilePartUploadRequest) (string, error) {
	var resp dmp.AudienceFilePartUploadResponse
	if err := clt.Upload("v1.0/qianchuan/audience_file/part_upload/", req, &resp, accessToken); err != nil {
		return "", err
	}
