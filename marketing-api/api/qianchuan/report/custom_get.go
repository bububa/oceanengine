...
func CustomGet(clt *core.SDKClient, accessToken string, req *report.CustomGetRequest) (*report.CustomGetResult, error) {
	var resp report.CustomGetResponse
	err := clt.Get("v1.0/qianchuan/report/custom/get/", req, &resp, accessToken)
	if err != nil {
		return nil, err
	}
