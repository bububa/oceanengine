...
func LqAdGet(clt *core.SDKClient, accessToken string, req *ad.LqAdGetRequest) ([]uint64, error) {
	var resp ad.LqAdGetResponse
	if err := clt.Get("v1.0/qianchuan/lq_ad/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
