...
func QuotaGet(clt *core.SDKClient, accessToken string, advertiserID uint64) (*ad.QuotaGetResult, error) {
	var resp ad.QuotaGetResponse
	if err := clt.Get("v1.0/qianchuan/ad/quota/get/", &ad.QuotaGetRequest{
