...
import (
	...
	qianchuan "github.com/bububa/oceanengine/marketing-api/model/qianchuan/file"
)
...
func ImageGet(clt *core.SDKClient, accessToken string, req *qianchuan.ImageGetRequest) (*file.ImageGetResponseData, error) {
	var resp file.ImageGetResponse
	if err := clt.Get("v1.0/qianchuan/image/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
