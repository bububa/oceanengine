...
func VideoOriginalGet(clt *core.SDKClient, accessToken string, req *file.VideoOriginalGetRequest) ([]string, error) {
	var resp file.VideoOriginalGetResponse
	if err := clt.Get("v1.0/qianchuan/file/video/original/get/", req, &resp, accessToken); err != nil {
		return nil, err
	}
