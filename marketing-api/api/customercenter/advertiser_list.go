...
func AdvertiserList(clt *core.SDKClient, accessToken string, req *customercenter.AdvertiserListRequest) (*customercenter.AdvertiserListData, error) {
	var resp customercenter.AdvertiserListResponse
	if err := clt.Get("2/customer_center/advertiser/list/", req, &resp, accessToken); err != nil {
		return nil, err
	}
